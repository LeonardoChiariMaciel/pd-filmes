...
const API_URL = `https://api.themoviedb.org/3/movie/popular?api_key=$6ab77870d8ea9e9be0c6e259c2c5405f&language=pt-BR&page=1`;

fetch(URL)
  .then(res => res.json())
  .then(data => {
    const filmes = data.results.slice(0, 5); // Pega os 5 primeiros filmes
    let filmesHtml = '';
